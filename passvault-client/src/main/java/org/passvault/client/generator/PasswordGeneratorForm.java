...
public class PasswordGeneratorForm extends JFrame {
	...
	private PasswordGeneratorForm(GeneratorParameters.Builder params) {
		...
		//set initial values
		this.charactersTextArea.setText(new String(params.chars));
		this.specialCharactersTextArea.setText(new String(params.specialChars));
		this.specialChacactersCheckBox
	...
	private void $$$setupUI$$$() {
		...
		optionsPanel.add(characterSetLabel, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
		alphannumericCharactersTextAreaScrollPane = new JScrollPane();
		optionsPanel.add(alphannumericCharactersTextAreaScrollPane, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
		charactersTextArea = new JTextArea();
		charactersTextArea.setLineWrap(true);
		charactersTextArea.setText("");
		alphannumericCharactersTextAreaScrollPane.setViewportView(charactersTextArea);
